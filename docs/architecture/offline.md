...
App shell: cache first. `index.html`, `index-digital-clock.html`, CSS, JavaScript, local fonts, manifest, and icons are precached.
...
`index.html` preserves search and hash state while redirecting to `index-digital-clock.html`.
